...
<head>
  ...
  <meta name="description" content="Projek Skripsi Sekolah">
    <meta name="author" content="Reza Nurfachmi">
    <meta name="keywords" content="Universitas Raharja - Aku Makin Cinta Raharja">
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="username" aria-describedby="username" name="username" placeholder="Enter Username..." autofocus="on">
                    </div>
                    <div class="form-group">
                  ...
                  <a href="<?=base_url('auth/siswa');?>" class="btn btn-warning mt-3 btn-block">Masuk sebagai Siswa</a>
                </div>
              </div>
            </div>
          </div>
